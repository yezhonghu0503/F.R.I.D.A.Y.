...
const getWebviewContent = (markdownMsg: any): string => {
	return `<html><style>body{background: url('https://blog.al2p.xyz/upload/original-035e87c5a88c791e04d7aa20039bcc55.png') no-repeat;background-size: 100%;}</style> <body> <div>${markdownMsg}</div> </body> </html>`;
};
const collectCode = () => {

...
const getWebviewContent = (markdownMsg: any): string => {
	return `<html><style>body{background: url('https://cdn.dribbble.com/userupload/3234656/file/original-035e87c5a88c791e04d7aa20039bcc55.png?compress=1&resize=752x')}</style> <body> <div>${markdownMsg}</div> </body> </html>`;
};
const collectCode = () => {

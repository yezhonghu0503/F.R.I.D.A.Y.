...
const getWebviewContent = (markdownMsg: any): string => {
	...
	<html>
	<head>
	<link rel="shortcut icon" type="image/x-icon" href="https://blog.al2p.xyz/upload/original-d65b37185f7849deeb249555b5514e7f.png" />
	</head>
	<style>
    html {
		width:100vw;
...
const collectCode = () => {
	...
	axios.get('http://129.226.201.240:3000/chat', { params: { msg: `${question}` } }).then(res => {
		...
		const html = highlightAuto(markdown).value;
